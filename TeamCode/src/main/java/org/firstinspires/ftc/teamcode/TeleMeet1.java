...
@TeleOp(name="Tele Regionals", group="Qual")
public class TeleMeet1 extends OpMode
{
    ...
    ButtonReader square1ButtonReader, triangle1ButtonReader, circle1ButtonReader, x1ButtonReader;
    ...
    public void init() {
        ...
        square1ButtonReader = new ButtonReader(gpA, GamepadKeys.Button.X);
        triangle1ButtonReader = new ButtonReader(gpA, GamepadKeys.Button.Y);
        x1ButtonReader = new ButtonReader(gpA, GamepadKeys.Button.A);
        circle1ButtonReader = new ButtonReader(gpA, GamepadKeys.Button.B);
    ...
    public void loop() {
        ...
        x1ButtonReader.readValue();
        circle1ButtonReader.readValue();
        square1ButtonReader.readValue();
        triangle1ButtonReader.readValue();

        if (x1ButtonReader.wasJustPressed() || circle1ButtonReader.wasJustPressed() || square1ButtonReader.wasJustPressed() || triangle1ButtonReader.wasJustPressed()) {
            if (hangServo.getPosition() == STEMperFiConstants.LEVEL_ONE_HANG_DRIVE) {
